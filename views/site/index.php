            ...
            <div class="w-full border-l-2 px-4">
              <ul class="flex flex-col gap-12 px-8 relative">
                ...
                <li id="listItem4">
                  ...
                  <div>
                    <a href="http://localhost:8077/spa" class="font-semibold text-gray-700 text-xl">Калькулятор расчетов</a>
                ...
                <li id="listItem5">
                  ...
                  <div>
                    <a href="http://localhost:8077/swagger-ui" class="font-semibold text-gray-700 text-xl">API документация</a>
