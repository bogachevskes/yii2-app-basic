        ...
        <section class="h-screen home-page">
            <div class="flex flex-col lg:flex-row container gap-20 h-full items-center justify-center m-auto w-full">
                <div class="flex flex-col">
                    ...
                    <p id="subtitle" class="text-gray-700 font-normal lg:text-5xl text-2xl text-left">Цифровые решения</p>
                    <div id="projectInfo" class="flex items-end container justify-between mt-10 mx-auto">
          ...
          Меня зовут <b>[ваше_имя]</b> <br> Это мой первый проект, на стеке HTML, CSS, JS, PHP, SQL
                ...
                <div class="w-full border-l-2">
                    <ul class="flex flex-col gap-12 px-8 relative">
                        <li>
                            <div class="absolute -left-5 bg-white border-2 h-10 hidden items-center justify-center lg:flex rounded w-10">
                            ...
                            <div id="listItem1">
                                <a href="https://edu-efko.ru/" class="font-semibold text-gray-700 text-xl">Сайт курса</a>
                        ...
                        <li id="listItem2">
                            ...
                            <div>
                                <a href="https://t.me/efko_digital" class="font-semibold text-gray-700 text-xl">Telegram</a>
                                <p class="font-semibold text-gray-400 text-sm">Подпишись на группу и будь в курсе всех новостей</p>
                            </div>
                        </li>

                        <li id="listItem3">
                            <div class="absolute -left-5 bg-white border-2 h-10 hidden items-center justify-center lg:flex rounded w-10 bottom-0">
                            ...
                            <div>
                                <a class="font-semibold text-gray-700 text-xl" href="[ссылка_на_github]">GitHub</a>
                                <p class="font-semibold text-gray-400 text-sm">Мой аккаунт на GitHub</p>
                            </div>
                        </li>
                    </ul>
                </div>
