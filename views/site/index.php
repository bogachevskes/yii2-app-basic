...
<div class="wrapper">
    <header class="w-full absolute my-8 left-0 top-0">
        <div class="mx-auto container">
            ...
            <main class=""><section class="h-screen home-page">
            ...
            <div class="w-full border-l-2 px-4">
              <ul class="flex flex-col gap-12 px-8 relative">
                ...
                <li id="listItem4">
                  ...
                  <div>
                    <a href="https://gitlab-dev.efko.ru/workshop/system-analitycs/legacy-calculator-v3" class="font-semibold text-gray-700 text-xl">Калькулятор расчетов</a>
                    <p class="font-semibold text-gray-400 text-sm">Изучи проект</p>
                  </div>
                </li>
                ...
                <li id="listItem5">
                  ...
                  <div>
                    <a class="font-semibold text-gray-700 text-xl">API документация</a>
                    <p class="font-semibold text-gray-400 text-sm">Изучи API для интеграции</p>
                  </div>
                </li>
              </ul>
            </div>
